...
export const PLAYBOOKS: Playbook[] = [
...

  {
    ...
    affectedServices: ['database', 'authentication', 'user-service'],
...

  {
    ...
    affectedServices: ['database', 'api-gateway', 'payment-service'],
...

  {
    ...
    affectedServices: ['database', 'order-service', 'payment-service'],
...

  {
    ...
    affectedServices: ['user-service', 'analytics-engine'],
...

  {
    ...
    affectedServices: ['user-service', 'analytics-engine', 'payment-service'],
...

  {
    ...
    affectedServices: ['cache', 'user-service', 'order-service'],
...

  {
    ...
    affectedServices: ['api-gateway', 'payment-service', 'order-service'],
...

  {
    ...
    affectedServices: ['authentication', 'api-gateway', 'user-service'],
...

  {
    ...
    affectedServices: ['deployment', 'api-gateway', 'user-service'],
...

  {
    ...
    affectedServices: ['deployment', 'api-gateway', 'order-service'],
...

  {
    ...
    affectedServices: ['health-check', 'api-gateway'],
...

  {
    ...
    affectedServices: ['database', 'logging', 'api-gateway'],
...

  {
    ...
    affectedServices: ['cache', 'api-gateway', 'user-service'],
...

  {
    ...
    affectedServices: ['logging', 'api-gateway', 'user-service'],
...

  {
    ...
    affectedServices: ['system', 'monitoring'],
