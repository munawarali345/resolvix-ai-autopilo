...
export const RUNBOOKS: Runbook[] = [
...

  {
    ...
    triggerConditions: ['cpu high db', 'memory high db', 'slow database'],
...

  {
    ...
    triggerConditions: ['auth failure', 'token invalid', 'login API 500'],
...

  {
    ...
    triggerConditions: ['rate limit exceeded', 'traffic spike', 'api overload'],
